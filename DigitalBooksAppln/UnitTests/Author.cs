...
namespace UnitTests
{
    ...
    internal class Author
    {
        ...
        public void CreateAsync_OnPassingBookDetails_CreateBooks()
        {
            ...
            _mock.Setup(x => x.CreateAsync(It.IsAny<Book>())).ReturnsAsync(book);

            //Act
            var actualResult = _mock.Object.CreateAsync(bookModel);
        ...
        public void EditAsync_OnPassingBookId_UpdateBooks()
        {
            ...
            //Act
            var actualResult = _mock.Object.EditAsync(book, id);
